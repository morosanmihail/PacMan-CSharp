	...
	public static class StateInfo
	{
        ...
        public static Ghost NearestEdibleGhost(GameState gs)
        {
            ...
            foreach (var ghost in gs.Ghosts)
            {
                ...
                else if (_nearestGhost.Node.ManhattanDistance(gs.Pacman.Node) > ghost.Node.ManhattanDistance(gs.Pacman.Node)
        ...
        public static Ghost NearestGhost(GameState gs)
        {
            ...
            foreach (var ghost in gs.Ghosts)
            {
                ...
                else if (_nearestGhost.Node.ManhattanDistance(gs.Pacman.Node) >
                         ghost.Node.ManhattanDistance(gs.Pacman.Node))
                {
                    _nearestGhost = ghost;
                }
            }
